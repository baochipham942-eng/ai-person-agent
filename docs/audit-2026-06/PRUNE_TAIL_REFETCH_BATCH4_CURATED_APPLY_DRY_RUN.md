...
Generated at: 2026-06-10T14:40:13.377Z
Mode: dry-run
...
| --- | --- | --- | --- | --- | --- | --- |
| Chris Olah | replace_source | exa | A Mathematical Framework for Transformer Circuits | transformer-circuits.pub | would_insert_raw | would_insert_keep_audit |
| Dario Amodei | replace_source | exa | Dario Amodei | darioamodei.com | would_update_raw | keep_audit_exists |
| Dario Amodei | replace_source | exa | Read the full transcript of our interview with Anthropic CEO Dario Amodei - CBS... | cbsnews.com | would_insert_raw | would_insert_keep_audit |
| Dario Amodei | replace_source | official | Dario Amodei - Stanford Digital Economy Lab | digitaleconomy.stanford.edu | would_insert_raw | would_insert_keep_audit |
| Guillaume Lample | augment_source | exa | Guillaume Lample | forbes.com | would_insert_raw | would_insert_keep_audit |
| Guillaume Lample | replace_source | official | LLaMA: Open and Efficient Foundation Language Models - Meta AI | ai.meta.com | would_insert_raw | would_insert_keep_audit |
| Guillaume Lample | replace_source | paper | [PDF] arXiv:1901.07291v1 [cs.CL] 22 Jan 2019 | arxiv.org | would_insert_raw | would_insert_keep_audit |
...
| Noam Shazeer | replace_source | exa | Universally Accessible Intelligence \| Andreessen Horowitz | a16z.com | would_insert_raw | would_insert_keep_audit |
| Sam Altman | augment_source | exa | Sam Altman: The Future of OpenAI, ChatGPT's Origins, and Building AI Hardware :... | ycombinator.com | would_insert_raw | would_insert_keep_audit |
| Sam Altman | augment_source | podcast | #107 - Vinod Khosla and Sam Al… – Y Combinator Startup Podcast – Apple Podcasts | podcasts.apple.com | would_insert_raw | would_insert_keep_audit |
...
| 阿希什·瓦斯瓦尼 | replace_source | exa | Ashish Vaswani - The Montgomery Summit | montgomerysummit.com | would_insert_raw | would_insert_keep_audit |
