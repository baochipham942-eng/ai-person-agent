...
Generated at: 2026-06-10T07:48:32.161Z
Source archive: docs/audit-2026-06/data/exa_source_quality_review_dir/refetch_source_followup_mixed_apply_archive.json
...
| --- | --- |
| planned people | 5 |
| people with proposed cards | 5 |
| existing cards archived | 68 |
| proposed cards | 25 |

## People

| Person | Status | Trigger Sources | Usable Keep Sources | Existing Cards | Proposed Cards | Skipped |
| --- | --- | --- | --- | --- | --- | --- |
| Yoshua Bengio | ready | 6 | 45 | 12 | 6 |  |
| 周明 | active | 5 | 17 | 18 | 3 |  |
| 杨植麟 | active | 5 | 21 | 15 | 5 |  |
| 闫俊杰 | active | 5 | 12 | 9 | 6 |  |
| 亚历克·拉德福德 | ready | 4 | 43 | 14 | 5 |  |
...
- insight/4: 通用人工智能（AGI）对国家与国际安全的深远影响 — Bengio 在为阿斯彭战略小组撰写的论文中指出，AGI 的出现将彻底改变国家安全格局。他认为，AI 不仅仅是生产力工具，更是影响国际地缘政治平衡的关键变量。他主张必须从政策层面思考 AGI 对全球安全体系的冲击，并呼吁建立跨国界的协作机...
...
- fact/4: 出任创新工场首席科学家 — 周明博士在创立澜舟科技的同时，还担任创新工场的首席科学家。作为世界顶级的AI科学家和NLP领域代表人物，他不仅在学术界拥有极高声望（谷歌H-Index达107），还通过这一角色连接学术前沿与产业投资，助力AI 2.0时代的创业孵化与技术落...
...
- fact/3: 闫俊杰的学术背景与精英荣誉 — 闫俊杰出生于1989年，河南人，2015年博士毕业于中科院自动化所模式识别国家重点实验室。他曾入选2024年《财富》中国40位40岁以下的商界精英，是国内AI领域典型的学院派创业代表。
...
- insight/5: 零样本迁移能力的对数线性增长规律 — 在 GPT-2 的核心研究中，拉德福德发现语言模型的零样本（Zero-shot）任务迁移能力并非随机出现，而是随着模型容量（参数规模）的增加，在多个任务上呈现出稳定的对数线性性能提升。这一洞见为后来 GPT-3 乃至更大规模模型的研发提供...
