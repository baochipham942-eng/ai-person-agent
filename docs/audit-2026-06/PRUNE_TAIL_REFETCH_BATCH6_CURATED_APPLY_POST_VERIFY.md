...
Generated at: 2026-06-10T15:25:35.483Z
Mode: dry-run
...
| Mustafa Suleyman | augment_source | podcast | What is an AI anyway? \| Mustaf… - TED Talks Daily - Apple Podcasts | podcasts.apple.com | would_update_raw | keep_audit_exists |
| Oriol Vinyals | replace_source | official | Oriol Vinyals - Research at Google | research.google.com | would_update_raw | keep_audit_exists |
| Percy Liang | replace_source | official | Jacob Steinhardt | simons.berkeley.edu | would_update_raw | keep_audit_exists |
...
| Percy Liang | replace_source | official | Percy Liang - Stanford Profiles | profiles.stanford.edu | would_update_raw | keep_audit_exists |
| Sam Altman | augment_source | exa | Sam Altman May Control Our Future—Can He Be Trusted? | newyorker.com | would_update_raw | keep_audit_exists |
| Wojciech Zaremba | augment_source | exa | Wojciech Zaremba — What Could Make AI Conscious? \| gradient-dissent – Weights &... | wandb.ai | would_update_raw | keep_audit_exists |
| Wojciech Zaremba | augment_source | podcast | Wojciech Zaremba — What Could Make AI Conscious? - Gradient Dissent: Conversati... | podcasts.apple.com | would_update_raw | keep_audit_exists |
| Yann LeCun | replace_source | exa | 20VC: Yann LeCun on Why Artificial Intelligence Will Not Dominate Humanity, Why... | thetwentyminutevc.com | would_update_raw | keep_audit_exists |
