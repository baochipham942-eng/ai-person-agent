...
Generated at: 2026-06-10T16:04:12.228Z
Mode: dry-run
...
| Alexandr Wang | replace_source | exa | Alexandr Wang on Masters of Scale | mastersofscale.com | would_insert_raw | would_insert_keep_audit |
| Andrej Karpathy | augment_source | exa | Andrej Karpathy — AGI is still a decade away - Dwarkesh Podcast | dwarkesh.com | would_insert_raw | would_insert_keep_audit |
| Andrej Karpathy | augment_source | exa | Andrej Karpathy's LLM Council - Unbound Security | docs.getunbound.ai | would_insert_raw | would_insert_keep_audit |
| Andrej Karpathy | augment_source | youtube | Andrej Karpathy — “We're summoning ghosts, not building animals” | youtube.com | would_insert_raw | would_insert_keep_audit |
| Arthur Mensch | replace_source | official | Arthur Mensch, CEO of Mistral, acting as a big brother at École ... | polytechnique.edu | would_insert_raw | would_insert_keep_audit |
| Chris Olah | replace_source | exa | Chris Olah: The 100 Most Influential People in AI 2024 - TIME | time.com | would_insert_raw | would_insert_keep_audit |
| Chris Olah | replace_source | exa | Christopher Olah - colah's blog | colah.github.io | would_update_raw | keep_audit_exists |
| Christopher Manning | replace_source | exa | Christopher Manning \| IEEE Awards | corporate-awards.ieee.org | would_insert_raw | would_insert_keep_audit |
...
| Demis Hassabis | replace_source | exa | Demis Hassabis – Interview - NobelPrize.org | nobelprize.org | would_insert_raw | would_insert_keep_audit |
...
| Demis Hassabis | replace_source | exa | Transcript from an interview with Demis Hassabis | nobelprize.org | would_insert_raw | would_insert_keep_audit |
| Emad Mostaque | replace_source | exa | Stability AI Announcement | stability.ai | would_update_raw | keep_audit_exists |
| Emad Mostaque | replace_source | exa | Stability AI Founder Emad Mostaque Plans To Resign As CEO, Sources Say | forbes.com | would_insert_raw | would_insert_keep_audit |
...
| Emad Mostaque | augment_source | exa | Stable Diffusion's AI Benefactor Has A History Of Exaggeration | forbes.com | would_insert_raw | would_insert_keep_audit |
| Emad Mostaque | augment_source | podcast | EP 46: Emad Mostaque (Founder/… – The Logan Bartlett Show – Apple Podcasts | podcasts.apple.com | would_insert_raw | would_insert_keep_audit |
...
| Geoffrey Hinton | replace_source | official | [PDF] Rectified Linear Units Improve Restricted Boltzmann Machines | cs.toronto.edu | would_insert_raw | would_insert_keep_audit |
