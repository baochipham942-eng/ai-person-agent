...
Generated at: 2026-06-10T11:25:00.065Z
Mode: dry-run
Input: docs/audit-2026-06/data/org_review_decisions_2026_06_10.json
Archive: docs/audit-2026-06/data/org_review_first_dry_run_archive.json
...
| merge decisions | 7 |
| keep decisions | 3 |
| member organizations to delete | 7 |
| PersonRole rows to repoint | 9 |
| duplicate PersonRole rows to delete | 0 |
| People.organization rows to update | 7 |
