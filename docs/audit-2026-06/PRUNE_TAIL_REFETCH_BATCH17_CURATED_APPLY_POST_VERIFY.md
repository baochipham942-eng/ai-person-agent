...
Generated at: 2026-06-10T18:41:17.141Z
Mode: dry-run
...
| existing RawPoolItems | 15 |
| raw inserted | 0 |
| raw updated | 15 |
| keep audits inserted | 0 |
| keep audits already existed | 15 |
...
| Arthur Mensch | replace_source | exa | Arthur Mensch: The 100 Most Influential People in AI 2024 | time.com | would_update_raw | keep_audit_exists |
...
| John Schulman | replace_source | exa | OpenAI co-founder John Schulman says he will join rival Anthropic | cnbc.com | would_update_raw | keep_audit_exists |
...
| Yann LeCun | augment_source | exa | [PDF] Gradient-based Planning with World Models - Jyothir S V | jyothirsv.github.io | would_update_raw | keep_audit_exists |
| Yann LeCun | augment_source | exa | DEEP LEARNING · Deep Learning | atcold.github.io | would_update_raw | keep_audit_exists |
...
| 吴恩达 | augment_source | official | Andrew Ng \| Stanford HAI | hai.stanford.edu | would_update_raw | keep_audit_exists |
