...
Generated at: 2026-06-10T19:26:49.477Z
Mode: dry-run
...
| --- | --- | --- | --- | --- | --- | --- |
| 吴恩达 | replace_source | exa | Generative AI for Everyone - DeepLearning.AI | deeplearning.ai | would_insert_raw | would_insert_keep_audit |
| 吴恩达 | replace_source | exa | Generative AI for Everyone \| Coursera | coursera.org | would_insert_raw | would_insert_keep_audit |
| 吴恩达 | replace_source | exa | Machine Learning \| Coursera | coursera.org | would_insert_raw | would_insert_keep_audit |
| 吴恩达 | replace_source | exa | Machine Learning Specialization - DeepLearning.AI | deeplearning.ai | would_insert_raw | would_insert_keep_audit |
...
| 李开复 | augment_source | exa | 零一万物-AI2.0大模型技术和应用的全球公司 | lingyiwanwu.com | would_insert_raw | would_insert_keep_audit |
...
| 桑达尔·皮查伊 | augment_source | exa | How Sundar Pichai Pushed Google To the Front of the AI Race - TIME | time.com | would_insert_raw | would_insert_keep_audit |
| 桑达尔·皮查伊 | augment_source | exa | 麻省理工科技评论-独家专访谷歌CEO桑达尔·皮查伊：基于我的个人经历 | mittrchina.com | would_update_raw | keep_audit_exists |
| 桑达尔·皮查伊 | replace_source | official | Sundar Pichai \| Google Blog | blog.google | would_insert_raw | would_insert_keep_audit |
| 贾里德·卡普兰 | augment_source | paper | [PDF] Scaling Laws for Autoregressive Generative Modeling \| Semantic Scholar | semanticscholar.org | would_insert_raw | would_insert_keep_audit |
