...
Generated at: 2026-06-10T16:58:30.858Z
Mode: execute
...
| --- | --- | --- | --- | --- | --- | --- |
| Daniela Amodei | augment_source | exa | Anthropic cofounder says studying the humanities will be 'more important than e... | fortune.com | inserted_raw | inserted_keep_audit |
| Daniela Amodei | augment_source | official | Anthropic raises $124 million to build more reliable, general AI systems \ Anth... | anthropic.com | inserted_raw | inserted_keep_audit |
| Daniela Amodei | augment_source | official | Daniela Amodei (Anthropic) – ‘Helpful, Honest, Harmless’ AI \| Stanford Technolo... | stvp.stanford.edu | updated_raw | keep_audit_exists |
| Elon Musk | replace_source | exa | Elon Musk launches Grokipedia as an alternative to 'woke' Wikipedia | nbcnews.com | inserted_raw | inserted_keep_audit |
