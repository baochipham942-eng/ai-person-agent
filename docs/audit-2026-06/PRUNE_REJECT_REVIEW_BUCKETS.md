...
Generated at: 2026-06-10T08:46:40.869Z
Input: docs/audit-2026-06/data/prune_candidates_after_card_reaggregation.json
...
| reject rows | 924 |
| review rows | 306 |
| strict delete candidates | 266 |
| defer/refetch candidates | 964 |

## Reject Buckets

| Bucket | Count |
| --- | ---: |
| manual_review_tail | 462 |
| low_information_auxiliary | 164 |
| empty_or_unusable_capture | 126 |
| author_or_direct_evidence_missing | 114 |
| over_attributed_or_org_level | 32 |
...
### reject / wrong_person_or_same_name

| Person | Source | Title | Reason |
| --- | --- | --- | --- |
| Aakash Gupta | github | Acash512/Aris | 同名开发者，内容为针对特定学校的新闻应用。 |
| Aakash Gupta | github | Acash512/COVID-19_Tracker_India | 同名开发者，内容为普通的疫情追踪应用，与目标人物无关。 |
| Aakash Gupta | github | Acash512/GoogleLensClone | 同名开发者，虽涉及机器学习技术但并非目标人物。 |
| Aakash Gupta | github | Acash512/TicTacToe_DesktopApp | 同名开发者，内容为基础的Java练习项目。 |
| Aakash Gupta | youtube | Aakash Gupta \| Angry Young Man \| Full Stand-up Comedy Special | 同名者，内容为脱口秀专场视频。 |
| Aakash Gupta | youtube | My Corporate Job \| Aakash Gupta \| Stand-up comedy | 该内容属于同名印度脱口秀演员，而非从事 Product Growth 的目标人物，且内容为纯娱乐脱口秀。 |
| Aakash Gupta | youtube | School \| Aakash Gupta \| Stand-up Comedy | 同名者，内容为关于校园生活的脱口秀表演。 |
| Aakash Gupta | youtube | Summer is coming \| Aakash Gupta \| Stand-up Comedy | 同名者，内容为脱口秀表演，非目标产品增长专家。 |
| Aidan Gomez | exa | Aidan Gomez – Medium | 内容涉及区块链和云技术且风格不符，推测为同名者的文章。 |
| Alexandr Wang | github | alexandr/6882demos | GitHub仓库名为alexandr，但内容为MIT课程演示，与目标人物无关。 |
| Alexandr Wang | github | alexandr/layer-identity-token-nodejs | GitHub仓库名为alexandr，但内容为通用Node.js代码，与目标人物无关。 |
| Alexandr Wang | github | alexandr/simpletextserver | GitHub仓库名为alexandr，但内容为简单Flask服务器，与目标人物无关。 |

### reject / manual_review_tail

| Person | Source | Title | Reason |
| --- | --- | --- | --- |
| Aidan Gomez | exa | Aidan Gomez's Playlists \| Computer Science & Mathematics | 内容仅为人物的个人音乐播放列表，与AI研究或职业背景无关。 |
...
| Aidan Gomez | github | Cpp-AES | 内容是关于AES加密算法的通用实现，与Aidan Gomez本人无关。 |
...
| Aidan Gomez | github | pygorithmic | 内容是关于QuestTrade API封装的投资算法工具，与Aidan Gomez本人无关。 |
| Aidan Gomez | github | RandKit | 内容是关于随机数生成的Swift框架，与Aidan Gomez本人无关。 |
| Aidan Gomez | github | welcome | 内容是关于生成欢迎消息的通用项目，与Aidan Gomez本人无关。 |
...
### reject / empty_or_unusable_capture

| Person | Source | Title | Reason |
| --- | --- | --- | --- |
| Aidan Gomez | exa | Aidan Gomez | 内容为加载失败的Google Scholar页面片段，无有效信息，无法判断是否关于Aidan Gomez本人。 |
| Aidan Gomez | exa | Inside the Paper That Changed AI Forever - Cohere CEO ... | 内容仅显示标题和空数据，无有效信息，无法判断是否关于Aidan Gomez。 |
| Alexandr Wang | exa | 5 things to know about tech mogul Alexandr Wang, world’s youngest self-made billionaire | 抓取内容主要为网页导航和菜单，缺乏关于人物的实质性描述。 |
| Alexandr Wang | exa | Who is Alexandr Wang, AI pioneer, world's youngest self-made billionaire? | 内容几乎全是网页UI元素和登录链接，无有效信息密度。 |
| Andrej Karpathy | exa | Andrej Karpathy - Home | 仅包含网站Cookie政策说明，无人物相关信息。 |
| Andrej Karpathy | exa | Andrej Karpathy | 仅包含YouTube网页页脚导航信息，无实质内容。 |
| Andrej Karpathy | exa | karpathy’s gists | 仅为 GitHub Gists 的列表入口或登录页面，无具体代码或技术描述。 |
| Andrej Karpathy | x | //x.com/karpathy/status/1887211193099825254 | 内容仅为链接，无法判断其技术价值。 |
| Andrej Karpathy | x | //x.com/karpathy/status/1935518272667217925 | 内容仅为链接，无有效信息密度。 |
| Arthur Mensch | exa | Jensen Huang & Arthur Mensch: Why Every Nation Needs Its ... | 内容仅为YouTube登录页面，无有效信息，无法判断质量。 |
| Arthur Mensch | x | AI needs to be connected to the physical world, proud to be supporting ! | 内容过于简短，仅为一句口号，没有具体信息，且无法确认是否关于Arthur Mensch本人。 |
| Chris Olah | exa | Christopher Olah | 内容为Google Scholar加载失败页面，无实际信息，不相关且低质。 |
...
| Alexandr Wang | youtube | Alexandr Wang Says He&#39;s Waiting to have a Kid, Until Tech Like Neuralink is Ready | 涉及个人生活八卦与非主流科技观点，信息密度低且偏离职业核心。 |
...
| Daniela Amodei | exa | Inside Anthropic, the AI Company Betting That Safety Can Be a Winning Strategy | 文章主要关于Anthropic公司，而非Daniela Amodei本人，aboutPerson不达标。 |
| Demis Hassabis | exa | A new era of intelligence with Gemini 3 | 谷歌产品发布公告，与 Hassabis 个人关联度极低且内容空洞。 |
| Demis Hassabis | exa | About Google DeepMind | 仅为 DeepMind 机构的通用介绍页面，并非针对 Hassabis 个人。 |
| Elon Musk | x | xAI throws great parties | 关于公司派对的社交闲谈，缺乏技术或行业实质价值。 |
...
| Greg Brockman | exa | Introducing GPT-4.5 | 内容为 GPT-4.5 的产品发布公告，未直接涉及 Greg Brockman 的个人信息或观点。 |
| Greg Brockman | exa | OpenAI API | OpenAI API 的官方发布公告，属于机构产品新闻而非人物内容。 |
| Greg Brockman | exa | Summarizing books with human feedback | 内容为 OpenAI 机构的研究发布，未直接提及或关于 Greg Brockman 本人。 |
| Hyung Won Chung | exa | People | 机构为POSTECH且内容仅为实验室团队照片列表，无实质信息。 |

### reject / non_ai_domain_mismatch

| Person | Source | Title | Reason |
| --- | --- | --- | --- |
| Arthur Mensch | github | covidom_analysis | 这是他的GitHub仓库，关于分析Covidom数据，与AI/机器学习相关性低且内容简略。 |

### reject / author_or_direct_evidence_missing

| Person | Source | Title | Reason |
| --- | --- | --- | --- |
| Chamath Palihapitiya | x | Google DeepMind introduced AlphaEvolve, an AI coding agent that uses language models to d... | 内容仅介绍Google DeepMind的AlphaEvolve，未提及Chamath本人。 |
| Chamath Palihapitiya | x | What I read this week... 1) @Google announced Gemini 3 on November 18, 2025, calling it i... | 内容关于Google Gemini 3，未提及Chamath本人。 |
| Chamath Palihapitiya | x | What I read this week... 1) Meta will cut roughly 600 roles across its AI division, which... | 内容为Meta AI部门新闻，未提及Chamath本人。 |
| Christopher Manning | exa | Christopher D Manning | 页面内容加载失败，未包含实质性的学术引用数据或有效信息。 |
| Christopher Manning | exa | Industrial applications of large language models | 内容仅为学术期刊的导航和标题信息，未提及目标人物。 |
| Dario Amodei | exa | AI jobs danger: Sleepwalking into a white-collar bloodbath | 内容讨论 AI 对就业的影响，完全未提及目标人物 Dario Amodei。 |
| Dario Amodei | exa | Dario Amodei on why he left OpenAI \| Lex Fridman Podcast Clips | 抓取内容仅为 YouTube 的页脚法律条款和导航，未包含访谈实质内容。 |
| Dario Amodei | exa | Papers with Code - Dario Amodei | 页面标题虽有其名，但正文内容为通用的论文趋势列表，与本人无直接关联。 |
| Demis Hassabis | exa | Strengthening our partnership with the UK government to support prosperity and security i... | 内容仅为 Google DeepMind 机构层面的合作公告，未提及 Demis Hassabis 本人。 |
| Dylan Field | exa | Figma CEO Dylan Field: “I like the investors, but what ... | 内容主要由网站菜单和标签组成，未包含有效的访谈或观点细节。 |
| Dylan Field | x | Yes. I’m hoping we can identify great people to run against him in upcoming primary and i... | 纯政治选举讨论，与科技或AI行业无直接关联。 |
| Elon Musk | exa | The Year Ahead: AI | 内容主要讨论加拿大的AI主权和数据中心，未提及目标人物马斯克。 |
...
### review / wrong_person_or_same_name

| Person | Source | Title | Reason |
| --- | --- | --- | --- |
| Lukasz Kaiser | exa | Papers with Code - Łukasz Kaiser | 论文列表搜索结果，且包含同名作者 Łukasz Kuciński 的干扰信息。 |
| Quoc Le | exa | Kevin Clark - CS Stanford | 内容主要是 Kevin Clark 的简历，虽提到 Quoc Le 是其导师及合作者，但主体并非目标人物。 |
