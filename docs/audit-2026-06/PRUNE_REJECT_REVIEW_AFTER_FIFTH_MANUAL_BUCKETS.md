...
Generated at: 2026-06-10T10:58:04.940Z
Input: docs/audit-2026-06/data/prune_candidates_after_fifth_manual_review_prune.json
...
| defer/refetch candidates | 870 |

## Reject Buckets

| Bucket | Count |
| --- | ---: |
| manual_review_tail | 394 |
| low_information_auxiliary | 152 |
...
| Andrej Karpathy | x | //x.com/karpathy/status/1864023344435380613 | 内容仅为社交媒体链接，缺乏实质性文本信息。 |
| Andrej Karpathy | x | //x.com/karpathy/status/1869857966226321856 | 内容仅为社交媒体链接，缺乏实质性文本信息。 |
| Andrej Karpathy | x | //x.com/karpathy/status/1977763273786507691 | 内容仅为链接，不符合入库的信息密度要求。 |
| Andrej Karpathy | x | //x.com/karpathy/status/1990854771058913347 | 内容仅为链接，缺乏实质性的文字描述或观点。 |
