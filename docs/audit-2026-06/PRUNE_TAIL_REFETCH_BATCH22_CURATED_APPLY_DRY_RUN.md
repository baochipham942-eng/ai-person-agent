...
Generated at: 2026-06-10T19:56:52.918Z
Mode: dry-run
...
| --- | --- | --- | --- | --- | --- | --- |
| Boris Cherny | augment_source | exa | Building Claude Code with Boris Cherny - by Gergely Orosz | newsletter.pragmaticengineer.com | would_insert_raw | would_insert_keep_audit |
| Boris Cherny | augment_source | exa | Head of Claude Code: What happens after coding is solved \| Boris ... | lennysnewsletter.com | would_insert_raw | would_insert_keep_audit |
...
| Noam Shazeer | replace_source | exa | Ex-Google engineers who founded Character.AI re-join company with new AI partne... | nbcsandiego.com | would_insert_raw | would_insert_keep_audit |
...
| Sam Altman | replace_source | exa | Sam Altman - Forbes | forbes.com | would_insert_raw | would_insert_keep_audit |
| Sam Altman | replace_source | exa | Sam Altman \| Biography, OpenAI, ChatGPT, & Microsoft - Britannica | britannica.com | would_insert_raw | would_insert_keep_audit |
| Yann LeCun | replace_source | exa | [PDF] THE MNIST DATABASE of handwritten digits | lri.fr | would_insert_raw | would_insert_keep_audit |
...
| 乔尔·皮诺 | replace_source | exa | Joelle Pineau: What's inside the "black box" of AI? \| TED Talk | ted.com | would_insert_raw | would_insert_keep_audit |
...
| 雅各布·乌什科雷特 | replace_source | youtube | Inceptive CEO Jakob Uszkoreit On Transformers And Using AI To Make New Drugs | youtube.com | would_insert_raw | would_insert_keep_audit |
| 黄仁勋 | augment_source | exa | NVIDIA CEO 黄仁勋与全球技术领导者在GTC 2026 大会共话AI 时代 | blogs.nvidia.cn | would_insert_raw | would_insert_keep_audit |
| 黄仁勋 | augment_source | exa | NVIDIA CEO：“我们创造了为生成式 AI 时代而生的处理器” \| NVIDIA 英伟达博客 | blogs.nvidia.cn | would_insert_raw | would_insert_keep_audit |
