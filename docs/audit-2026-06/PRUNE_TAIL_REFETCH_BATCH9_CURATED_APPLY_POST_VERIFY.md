...
Generated at: 2026-06-10T16:20:44.114Z
Mode: dry-run
...
| --- | --- | --- | --- | --- | --- | --- |
| Greg Brockman | replace_source | exa | Meet the power broker of the AI age: OpenAI's 'builder-in-chief' helping to tur... | fortune.com | would_update_raw | keep_audit_exists |
...
| Lukasz Kaiser | augment_source | official | Virtual Event: Learning Powerful Models: From Transformers to Reasoners and Bey... | forum.openai.com | would_update_raw | keep_audit_exists |
| Mustafa Suleyman | augment_source | exa | IA Summit 2024: From SaaS to Agents With Mustafa Suleyman | madrona.com | would_update_raw | keep_audit_exists |
| Mustafa Suleyman | augment_source | exa | Microsoft AI chief walks back comments about AI taking over white-collar work \|... | theverge.com | would_update_raw | keep_audit_exists |
...
| Percy Liang | replace_source | exa | Percy Liang \| TEDAI San Francisco | tedai-sanfrancisco.ted.com | would_update_raw | keep_audit_exists |
| Quoc Le | replace_source | exa | Dr. Quoc Le and Ben Wilkinson join Fulbright University Vietnam Board | fulbright.edu.vn | would_update_raw | keep_audit_exists |
| Quoc Le | replace_source | exa | Dr. Quoc V. Le – Senior Advisor \| AI for Vietnam | aiforvietnam.org | would_update_raw | keep_audit_exists |
| Sam Altman | replace_source | exa | The Gentle Singularity - Sam Altman | blog.samaltman.com | would_update_raw | keep_audit_exists |
| Shane Legg | augment_source | exa | Shane Legg (DeepMind Founder) — 2028 AGI, superhuman ... | dwarkesh.com | would_update_raw | keep_audit_exists |
| Yoshua Bengio | replace_source | exa | ‘AI Godfather’ Yoshua Bengio: We need a humanity defense organization - Bulleti... | thebulletin.org | would_update_raw | keep_audit_exists |
...
| Yoshua Bengio | replace_source | exa | Yoshua Bengio \| TIME | time.com | would_update_raw | keep_audit_exists |
| Yoshua Bengio | replace_source | youtube | Interview with Yoshua Bengio on Mila's Major Scientific and Social Impact | youtube.com | would_update_raw | keep_audit_exists |
