...
Generated at: 2026-06-10T21:52:06.278Z
Mode: dry-run
Input: docs/audit-2026-06/data/prune_tail_review_thin_mismatch_manual_decisions.json
Archive: docs/audit-2026-06/data/prune_tail_review_thin_mismatch_manual_apply_dry_run_archive.json
...
| existing targets | 7 |
| missing targets | 0 |
| audit rows to insert | 7 |
| RawPoolItem rows to delete | 7 |
