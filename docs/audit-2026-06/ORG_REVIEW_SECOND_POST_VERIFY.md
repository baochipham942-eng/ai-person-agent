...
Generated at: 2026-06-10T12:25:26.443Z
Mode: dry-run
Input: docs/audit-2026-06/data/org_review_decisions_second_2026_06_10.json
Archive: docs/audit-2026-06/data/org_review_second_post_verify_archive.json
...
| keep decisions | 9 |
| member organizations to delete | 0 |
| PersonRole rows to repoint | 0 |
| duplicate PersonRole rows to delete | 0 |
| People.organization rows to update | 0 |

## Decisions

| Action | Canonical / Cluster | Members | Role changes | People labels | Reason |
| --- | --- | ---: | ---: | ---: | --- |
| merge_organization | Stanford HAI | 0 | 0 | 0 | Stanford HAI and Stanford Institute for Human-Centered Artificial Intelligence (HAI) refer to the same Stanford center; keep other Stanford departments, labs, and university-level rows separate. |
| merge_organization | Stanford University | 0 | 0 | 0 | Stanford University, Sequoia Professor is a position-bearing Stanford role, not a distinct organization; repoint the endowed-chair role to Stanford University. |
| rewrite_people_organization_labels | facebook_meta_history | 0 | 0 | 0 | Normalize People.organization display labels to canonical English organization names while keeping Facebook, FAIR, Meta AI, MetaMind, Metaweb, and Meta Superintelligence Labs separate. |
