...
export const loopEngineeringThread: KnowledgeThreadFixture = {
  ...
  sources: [
    ...
    source({
      ...
      url: 'https://addyo.substack.com/p/the-rise-of-loop-engineering',
      publishedAt: '2025-11-12',
      summary: '实践者文章把 loop engineering 表达成 plan-generate-review-refine 的迭代工作方式。',
      evidenceQuote: 'Loop engineering treats AI work as an iterative process.',
      evidenceNote: '可用于术语和实践者语境，不能覆盖官方定义。',
      confidence: 0.7,
      status: 'usable',
    }),
    source({
